...
const Pricing = () => {
  return (
    <div className="pt-20 pb-20 md:mx-auto md:max-w-[1480px]">
      ...
      <div className="mx-20 mt-20">
        <div className="grid md:mx-auto md:grid-cols-3 md:gap-0 md:gap-y-10 gap-y-6 justify-center">
          {/* Basic Plan Card */}
          <div className="grid gap-3 mx-auto bg-[#2D1B38] p-8 rounded-3xl md:w-[360px] md:h-[480px} w-[330px]">
            ...
            <div className="grid gap-5">
              ...
              <div className="flex flex-col gap-1">
                <p>
                  <span className="text-xl font-bold"></span>✔️ Custom
                  website
                </p>
                <p>
                ...
                <p>
                  <span className="text-xl font-bold"></span>✔️ Not included
                  in the plan
                </p>
                <p>
                  <span className="text-xl font-bold"></span>✔️{" "}
                  ~2 weeks to complete
                </p>
                <p>
                  <span className="text-xl font-bold"></span>✔️ 2 months
                  of free support
                </p>
                <p className="pt-2">
          ...
          {/* Premium Plan Card */}
          <div className="relative grid border-t-4 border-[#7D1A8D] gap-3 mx-auto bg-[#2D1B38] p-12 rounded-3xl md:w-[360px] md:h-[480px} w-[330px]">
            ...
            <div className="grid gap-5">
              ...
              <div className="flex flex-col gap-1">
                <p>
                  <span className="text-xl font-bold"></span>✔️ Custom designs & animations
                </p>
                <p>
                ...
                <p>
                  <span className="text-xl font-bold"></span>✔️ Includes full blog functionality
                </p>
                <p>
                  <span className="text-xl font-bold"></span>✔️{" "}
                ...
                <p>
                  <span className="text-xl font-bold"></span>✔️ 6 months
                  of priority support
                </p>
                <p className="pt-2">
          ...
          {/* Plus Plan Card */}
          <div className="grid gap-3 mx-auto bg-[#2D1B38] p-12 rounded-3xl md:w-[360px] md:h-[480px} w-[330px]">
            ...
            <div className="grid gap-5">
              ...
              <div className="flex flex-col gap-1">
                <div className="w-full border-t border-dashed border-white"></div>
                <p>
                  <span className="text-xl font-bold"></span>✔️ Premium designs with animation
                </p>
                <p>
                  <span className="text-xl font-bold"></span>✔️ Unlimited
                  pages
                </p>
                <p>
                  <span className="text-xl font-bold"></span>✔️ Full blog
