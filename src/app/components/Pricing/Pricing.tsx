    ...
    <div className="pt-20 pb-20 ">
      ...
      <div className="mx-20 mt-20">
        ...
        <div className="grid md:mx-auto md:grid-cols-3 md:gap-0 md:gap-y-10 gap-y-6 justify-center">
          <div className="grid gap-3 mx-auto bg-[#2D1B38] p-12 rounded-3xl md:w-[340px] md:h-[500px] w-[330px]">
          ...
          <div className="relative grid border-t-4 border-[#7D1A8D] gap-3 mx-auto bg-[#2D1B38] p-12 rounded-3xl md:w-[340px] md:h-[500px] w-[330px]">
