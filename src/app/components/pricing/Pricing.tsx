        ...
        <div className='pt-20 pb-20 bg-gradient-to-b from-[#181619] to-[#1F122A]'>
            ...
            <div className='mx-20 mt-20'>
                ...
                <div className='grid grid-cols-3 justify-center gap-20'>
                    <div className='grid gap-3 mx-auto bg-[#2D1B38] p-12 rounded-3xl w-[390px]'>
                        ...
                        <div className="divide-y divide-dashed grid gap-5">
                            ...
                            <div className='flex flex-col gap-3'>
                                <p className='flex gap-2 items-center mt-6'><span className='bg-white rounded-full py-[2px] px-[2.5px]'>✔️</span> 100 GB Storage</p>
                                <p className='flex gap-2 items-center'><span className='bg-white rounded-full py-[2px] px-[2.5px]'>✔️</span> 100 GB Storage</p>
                                <p className='flex gap-2 items-center'><span className='bg-white rounded-full py-[2px] px-[2.5px]'>✔️</span> 100 GB Storage</p>
                                <p className='flex gap-2 items-center'><span className='bg-white rounded-full py-[2px] px-[2.5px]'>✔️</span> 100 GB Storage</p>
                                <p className='flex gap-2 items-center'><span className='bg-white rounded-full py-[2px] px-[2.5px]'>✔️</span> 100 GB Storage</p>
                                <p className='flex gap-2 items-center'><span className='bg-white rounded-full py-[2px] px-[2.5px]'>✔️</span> 100 GB Storage</p>
                    ...
                    <div className='relative grid border-t-4 border-[#7D1A8D] gap-3 mx-auto bg-[#2D1B38] p-12 rounded-3xl w-[390px]'>
