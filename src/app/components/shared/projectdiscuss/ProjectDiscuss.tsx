...
const ProjectDiscuss = () => {
  return (
    <div className="text-center z-10 pb-24 text-white">
      ...
      <button className="mt-5 bg-gradient-to-r mb-2 border-4 text-lg gap-2 border-[#ffffffb2] from-[#49156D] to-[#49165C] hover:border-[#a33ed2] hover:from-[#6C00A5] hover:to-[#6A0170] duration-150 border-l-0 border-t-0 border-[#ffffff] my-8 py-2 px-6 rounded-lg border-light-200">
