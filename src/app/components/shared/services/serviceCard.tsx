...
const ServiceCard = ({ service }: any) => {
    return (
        <div className='w-[300px] backdrop-blur-md bg-[#2F1748] flex flex-col items-start border-l-0 border-t-0 border-[#5C099B] border-4 p-5 rounded-xl'>
            ...
            <button className='mt-auto border flex items-center gap-2 border-[#7272723c] bg-gradient-to-r from-[#49156D] to-[#49165C] px-5 py-2 rounded-md'>Read More <img className='w-4' src="https://i.ibb.co.com/gVjzd78/line-1.png" alt="" /></button>
        </div>
    );
};
